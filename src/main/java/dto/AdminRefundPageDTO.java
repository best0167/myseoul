...
public class AdminRefundPageDTO {
	...
	public AdminRefundPageDTO() {

	}


	public AdminRefundPageDTO(int currentPage, int totalCount) {
	...
	public AdminRefundPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
