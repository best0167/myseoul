...
public class UsersListPageDTO {
	...
	public UsersListPageDTO() {

	}


	public UsersListPageDTO(int currentPage, int totalCount) {
	...
	public UsersListPageDTO(int currentPage, int totalCount, String searchKey, String searchWord, int u_grade) {
