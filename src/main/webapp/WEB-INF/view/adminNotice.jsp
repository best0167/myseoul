...
<head>
    ...
    .pagelist a:hover, .pagelist .pagecolor{text-decoration: underline;color: red;}
...
<body>
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><b><i class="fa fa-dashboard"></i> Notice</b></h5>
    </header>
    <br>
    ...
    <div class="w3-container">
        <div id="boardwrap">
			...
			<div align="center">
				<form id="frm" name="frm" method="get" action="write2.do">
